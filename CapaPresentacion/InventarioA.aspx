<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.Master" AutoEventWireup="true" CodeBehind="InventarioA.aspx.cs" Inherits="CapaPresentacion.InventarioA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <h1 class="page-header">INVENTARIO <small>Modulo Inventario...</small></h1>

    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Panel de Inventario</h4>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <table id="tbInvent" class="table table-striped table-bordered align-middle text-nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Asociacion</th>
    ...
    <div class="modal fade" id="modalInven" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalLabelA">Detalle Inventario</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body">
                    <input id="txtIdInve" class="model" name="IdInven" value="0" type="hidden" />
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control model" type="text" id="txtCantidad" name="Cantidad" />
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="js/InventarioA.js" type="text/javascript"></script>
</asp:Content>
